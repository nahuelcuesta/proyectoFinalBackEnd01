...
const URL_MONGO = `mongodb+srv://admin:${process.env.MONGO_PASSWORD}@proyectofinal.3kmmqmx.mongodb.net/ecommerce?retryWrites=true&w=majority&appName=proyectoFinal`;
